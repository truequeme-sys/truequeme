                ...
                <div class="card-body" style="padding: 40px;">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col_full col_last">
                            ...
                            <input type="email" value="{{$invitacion->email}}" id="register-form-username" name="email" class="form-control" maxlength="100" required readonly/>
                        </div>

                        <div class="col_full">
                            <label for="register-form-name">Nombre:</label>
                            <input type="text" id="name" name="name" value="" class="form-control" maxlength="50"
                                required />
                        </div>
